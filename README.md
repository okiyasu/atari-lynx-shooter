...
cc65公式Lynxターゲット向けの小さな横スクロール2Dシューティングです。外部画像・音声素材は使わず、160x102・16色のTGI画面にコード内の固定水平ランと1bit行マスクから背景・キャラクターを描きます。Stage 1〜3を共通状態機械で進め、各通常区間の後にデータ駆動のボス戦へ入ります。Stage 1は宇宙、Stage 2は惑星上空、Stage 3は洞窟の固有背景・敵編成・ボスを持ちます。
